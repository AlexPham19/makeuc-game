...
VIETNAM_FLAG_IMAGE = pygame.image.load(r'E:\pygame\makeuc-game\play\Assets\vietnam_flag.png')
VIETNAM_FLAG = pygame.transform.scale(VIETNAM_FLAG_IMAGE, (100, 70))

USA_FLAG_IMAGE = pygame.image.load(r'E:\pygame\makeuc-game\play\Assets\usa_flag.png')
